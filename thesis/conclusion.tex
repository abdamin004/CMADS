...
dashboard plus the React doctor console for clinician inspection.
...
orchestration buys $+33.1$ percentage points on DIRECT and
$+19.4$ percentage points on Found over a single-call baseline at
identical patient data and identical reasoning model, with the gap
overwhelmingly attributable to the orchestration (exact McNemar
$p < 0.0001$ on 85 discordant pairs).
