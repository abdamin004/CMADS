...
\textbf{(O9)} the Streamlit research dashboard plus the React doctor
console for clinician inspection.
...
gating. A power calculation on the observed $+1.9$ percentage-point Found-rate
effect with the present discordance structure indicates that approximately
$n \geq 500$ paired patients would be required to detect the effect at
$\alpha = 0.05$ with $80\%$ power; reaching this cohort size is the
prerequisite for promoting the directional finding to a confirmed one.
