...
memory subsystem, the DIRECT rate is essentially unchanged (exact
McNemar $p = 1.0$ on 49 discordant pairs); the measurable effect is
on the wider differential (Found rate $91.9\% \to 93.8\%$, MISS rate
$8.1\% \to 6.2\%$). It does not, however, change the precision of
...
is essentially unchanged --- 25 patients improved by single-level
and 24 worsened by it on the same 160 paired UUIDs (49 discordant
pairs total, exact McNemar $p = 1.0$). On the same patients, the
Found rate rises from 91.9\% to 93.8\% and the MISS rate falls from
8.1\% to 6.2\%. The earlier 205-vs-100
