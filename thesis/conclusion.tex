...
memory subsystem, the DIRECT rate is essentially unchanged
($53.1\% \to 52.5\%$, exact McNemar $p = 1.0$ on 49 discordant pairs);
the measurable effect is on the wider differential
(Found rate $91.9\% \to 93.8\%$, MISS rate $8.1\% \to 6.2\%$). It
does not, however, change the precision of
...
is essentially unchanged --- 53.1\% with single-level memory versus
52.5\% with multi-level memory, with 25 patients improved by
single-level and 24 worsened by it (49 discordant pairs total, exact
McNemar $p = 1.0$). On the same patients, the Found rate rises from
91.9\% to 93.8\% and the MISS rate falls from 8.1\% to 6.2\%. The earlier 205-vs-100
