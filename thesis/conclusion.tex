...
memory subsystem, the DIRECT rate moves from 53.1\% to 52.5\% and an
exact McNemar on the 49 discordant pairs gives $p = 1.0$; shared
memory broadens the candidate differential the system considers
(Found rate 87.5\% $\to$ 93.8\%) but does not change the precision of
...
multi-level and 24 worsened by it (49 discordant pairs total, exact McNemar $p = 1.0$). On the
same patients, the Found rate rises from 87.5\% to 93.8\% and the
MISS rate falls from 12.5\% to 5.0\%. The earlier 205-vs-100
